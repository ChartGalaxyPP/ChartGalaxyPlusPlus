...
ChartGalaxy++ Image2JSON predicts elements, groups, hierarchy, text, bounding boxes, and appearance descriptions from a chart image. The model package contains the full Qwen3.5-4B-family checkpoint at step 100,000.
...
Download [ChartGalaxyPP/ChartGalaxyPlusPlus-Image2JSON](https://huggingface.co/ChartGalaxyPP/ChartGalaxyPlusPlus-Image2JSON).
